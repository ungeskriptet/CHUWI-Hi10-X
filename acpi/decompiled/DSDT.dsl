 ...
 *
 * Disassembly of ./DSDT, Tue Mar  5 17:36:18 2024
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000D89C (55452)
 *     Revision         0x02
 *     Checksum         0x27
 *     OEM ID           "ALASKA"
 *     OEM Table ID     "A M I "
...
DefinitionBlock ("", "DSDT", 2, "ALASKA", "A M I ", 0x01072009)
{
    ...
    OperationRegion (GNVS, SystemMemory, 0x79A9C118, 0x044A)
        ...
        Scope (\_SB.PCI0)
        {
            ...
            Scope (I2C0)
            {
                ...
                Device (ACCG)
                {
                    ...
                    Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                    {
                        ...
                        Return (RBUF) /* \_SB_.PCI0.I2C0.ACCG._CRS.RBUF */
                    }
                    ...
                    Method (ROTM, 0, NotSerialized)
                    {
                        ...
                        Return (RBUF) /* \_SB_.PCI0.I2C0.ACCG.ROTM.RBUF */
                    }
                    ...
                    Method (PRIM, 0, NotSerialized)
                    {
                        ...
                        Return (RBUF) /* \_SB_.PCI0.I2C0.ACCG.PRIM.RBUF */
                    }
                }
            }
            ...
            Scope (I2C1)
            {
                ...
                Device (ESSX)
                {
                    ...
                    Name (_DDN, "Everest Codec Controller ES8336")  // _DDN: DOS Device Name
                    Name (_UID, One)  // _UID: Unique ID
                    ...
                    Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                    {
                        ...
                        Return (SBUF) /* \_SB_.PCI0.I2C1.ESSX._CRS.SBUF */
                    }
        ...
        Device (H_EC)
        {
            ...
            Device (BAT0)
            {
                ...
                Method (_BIF, 0, NotSerialized)  // _BIF: Battery Information
                {
                    ...
                    Local0 = B1FV /* \_SB_.PCI0.SBRG.H_EC.B1FV */
                ...
                Method (_BST, 0, NotSerialized)  // _BST: Battery Status
                {
                    ...
                    Local1 = B1FV /* \_SB_.PCI0.SBRG.H_EC.B1FV */
                    PKG1 [0x02] = ((B1RC * Local1) / 0x03E8)
